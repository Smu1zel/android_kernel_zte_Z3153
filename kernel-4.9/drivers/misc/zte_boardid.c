...
static int secure_group_ver = -1;
static int __init secure_group_ver_setup(char *str)
{
	long value;
	int err;
	...
	if (err)
		return err;
	secure_group_ver = value;
	return 1;
}
__setup("secure_group_ver=", secure_group_ver_setup);
int zte_get_secure_group_ver(void)
{
	return secure_group_ver;
}
EXPORT_SYMBOL(zte_get_secure_group_ver);

static int non_secure_group_ver = -1;
static int __init non_secure_group_ver_setup(char *str)
{
	long value;
	int err;
	...
	if (err)
		return err;
	non_secure_group_ver = value;
	return 1;
}
__setup("non_secure_group_ver=", non_secure_group_ver_setup);
int zte_get_non_secure_group_ver(void)
{
	return non_secure_group_ver;
}
EXPORT_SYMBOL(zte_get_non_secure_group_ver);

static int avb_group_ver = -1;
static int __init avb_group_ver_setup(char *str)
{
	long value;
	int err;
...
__setup("avb_group_ver=", avb_group_ver_setup);
int zte_get_avb_group_ver(void)
{
	return avb_group_ver;
}
EXPORT_SYMBOL(zte_get_avb_group_ver);

static int recovery_group_ver = -1;
static int __init recovery_group_ver_setup(char *str)
{
	long value;
	int err;
	...
	if (err)
		return err;
	recovery_group_ver = value;
	return 1;
}
__setup("recovery_group_ver=", recovery_group_ver_setup);
int zte_get_recovery_group_ver(void)
{
	return recovery_group_ver;
}
EXPORT_SYMBOL(zte_get_recovery_group_ver);
...
static ssize_t zte_secure_group_ver_show(struct device *dev,
			struct device_attribute *attr,
			char *buf)
{
	return snprintf(buf, MAX_SIZE, "%d\n", secure_group_ver);
...
static ssize_t zte_non_secure_group_ver_show(struct device *dev,
			struct device_attribute *attr,
			char *buf)
{
	return snprintf(buf, MAX_SIZE, "%d\n", non_secure_group_ver);
}

static ssize_t zte_avb_group_ver_show(struct device *dev,
			struct device_attribute *attr,
			char *buf)
{
	return snprintf(buf, MAX_SIZE, "%d\n", avb_group_ver);
...
static ssize_t zte_recovery_group_ver_show(struct device *dev,
			struct device_attribute *attr,
			char *buf)
{
	return snprintf(buf, MAX_SIZE, "%d\n", recovery_group_ver);
...
static DEVICE_ATTR(secure_group_anti_ver, S_IRUGO, zte_secure_group_ver_show, NULL);
static DEVICE_ATTR(non_secure_group_anti_ver, S_IRUGO, zte_non_secure_group_ver_show, NULL);
static DEVICE_ATTR(avb_group_anti_ver, S_IRUGO, zte_avb_group_ver_show, NULL);
static DEVICE_ATTR(recovery_group_anti_ver, S_IRUGO, zte_recovery_group_ver_show, NULL);
...
static struct attribute *mvd_attrs[] = {
	...
	&dev_attr_secure_group_anti_ver.attr,
	&dev_attr_non_secure_group_anti_ver.attr,
	&dev_attr_avb_group_anti_ver.attr,
	&dev_attr_recovery_group_anti_ver.attr,
	NULL,
};
