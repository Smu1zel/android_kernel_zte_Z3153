...
struct charger_ops {
	...
	int (*send_ta_current_pattern_zte)(struct charger_device *, bool is_inc);

	int (*send_ta20_current_pattern)(struct charger_device *dev, u32 uV);
	int (*send_ta20_current_pattern_zte)(struct charger_device *dev, u32 uV);
	...
	int (*set_ship_mode)(struct charger_device *dev, bool en);
	int (*get_ship_mode)(struct charger_device *dev, bool *en);
};
...
extern int charger_dev_send_ta_current_pattern_zte(
	struct charger_device *charger_dev, bool is_increase);
extern int charger_dev_send_ta20_current_pattern(
	struct charger_device *charger_dev, u32 uV);
extern int charger_dev_send_ta20_current_pattern_zte(
	struct charger_device *charger_dev, u32 uV);
