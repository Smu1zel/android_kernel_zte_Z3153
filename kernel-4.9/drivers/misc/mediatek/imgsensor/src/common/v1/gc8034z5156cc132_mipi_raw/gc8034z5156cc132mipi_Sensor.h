 ...
 *
 ****************************************************************************/
#ifndef __GC8034Z5156CC132MIPI_SENSOR_H__
#define __GC8034Z5156CC132MIPI_SENSOR_H__

#define FULLSIZE_PREVIEW 0

/* SENSOR MIRROR FLIP INFO */
#define GC8034Z5156CC132_MIRROR_FLIP_ENABLE         1
#if GC8034Z5156CC132_MIRROR_FLIP_ENABLE
#define GC8034Z5156CC132_MIRROR		  0xc3
#define GC8034Z5156CC132_BIN_STARTY	  0x04
#define GC8034Z5156CC132_BIN_STARTX	  0x05
#define GC8034Z5156CC132_FULL_STARTY	  0x08
#define GC8034Z5156CC132_FULL_STARTX	  0x0b
#else
#define GC8034Z5156CC132_MIRROR		  0xc0
#define GC8034Z5156CC132_BIN_STARTY	  0x04
#define GC8034Z5156CC132_BIN_STARTX	  0x05
#define GC8034Z5156CC132_FULL_STARTY	  0x08
#define GC8034Z5156CC132_FULL_STARTX	  0x09
#endif
...
#define GC8034Z5156CC132OTP_FOR_CUSTOMER 1
/* Please do not enable the following micro definition, if you are not debuging otp function*/
#define GC8034Z5156CC132OTP_DEBUG 0

#define DD_WIDTH            3284
#define DD_HEIGHT           2464
#define GC8034Z5156CC132_OTP_ID_SIZE           9
#define GC8034Z5156CC132_OTP_ID_DATA_OFFSET    0x0010
...
struct gc8034z5156cc132_dd_t {
	kal_uint16 x;
	kal_uint16 y;
	kal_uint16 t;
};

struct gc8034z5156cc132_otp_t {
	kal_uint8 otp_id[GC8034Z5156CC132_OTP_ID_SIZE];
	kal_uint8  dd_cnt;
	kal_uint8  dd_flag;
	struct gc8034z5156cc132_dd_t dd_param[160];
	kal_uint8  reg_flag;
	kal_uint8  reg_num;
