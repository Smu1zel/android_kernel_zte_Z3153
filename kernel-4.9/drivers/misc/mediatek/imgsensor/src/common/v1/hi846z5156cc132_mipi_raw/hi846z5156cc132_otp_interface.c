...
#define PFX "HI846Z5156CC132_OTP_BASE"
...
void hi846z5156cc132_otp_setting(void)
{
	LOG_INF("%s enter\n", __func__);
...
void hi846z5156cc132_otp_disable(void)
{
...
int hi846z5156cc132_otp_read_(u32 offset, u8 *data, u32 size)
{
	int i = 0;
...
int hi846z5156cc132_otp_read(u32 offset)
{
