...
#define LOG_1 LOG_INF("sp5506,MIPI 2LANE\n")
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	{ 2592, 1944, 0, 0, 2592, 1944, 644, 480, 0, 0, 644, 480, 0, 0, 640, 480}, //hight speed video
	{ 2592, 1944, 0, 0, 2592, 1944, 1296,  972, 0, 0, 1296, 972, 0, 0, 1280, 960}  // slim video
};
...
static void sensor_init(void)
{
	...
	//sp5506R1A_AM01d
	//;;base_on_2592x1944_30FPS_MIPI_2_LANE_904Mbps
	//;Xclk 24Mhz
	...
	//;max_framerate: 30fps
	//;mipi_datarate per lane: 904Mbps

	//write_cmos_sensor(0x0100, 0x00);
	write_cmos_sensor(0x0103, 0x01);
	mDELAY(10);
	write_cmos_sensor(0x0300, 0x04);
	write_cmos_sensor(0x0302, 0x71);
...
static void preview_setting(void)
{
	...
	write_cmos_sensor(0x3817, 0x01);
	write_cmos_sensor(0x381e, 0x02);
	write_cmos_sensor(0x3820, 0x88);//0xb0
	write_cmos_sensor(0x3821, 0x01);
	write_cmos_sensor(0x4008, 0x02);
	write_cmos_sensor(0x4009, 0x0d);
	write_cmos_sensor(0x4041, 0x07);
