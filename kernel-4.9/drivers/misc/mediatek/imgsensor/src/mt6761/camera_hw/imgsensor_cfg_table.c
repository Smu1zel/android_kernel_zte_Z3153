...
#if defined(HI846Z5156CC132_MIPI_RAW) || defined(GC8034Z5156CC132_MIPI_RAW)
	{
...
#elif defined(GC8034Z5157V_MIPI_RAW) || defined(HI846Z5157V_MIPI_RAW)
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
...
#elif defined(GC5025_MIPI_RAW) || defined(ST55A_MIPI_RAW) || defined(SP5506_MIPI_RAW)
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
...
#if defined(SP2609Z5156CC092_MIPI_RAW)
	{
...
#elif defined(GC5025Z5157V_MIPI_RAW) || defined(SP5508Z5157V_MIPI_RAW)
	{
		IMGSENSOR_SENSOR_IDX_SUB,
		IMGSENSOR_I2C_DEV_1,
		{
...
struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence[] = {
	...
	{
		SENSOR_DRVNAME_HI846Z5156CC132_MIPI_RAW,
		{
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
			{DVDD, Vol_1200, 5},
...
#endif
#if defined(GC8034Z5156CC132_MIPI_RAW)
	{
		SENSOR_DRVNAME_GC8034Z5156CC132_MIPI_RAW,
		{
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1200, 5},
			{AVDD, Vol_2800, 1},
...
#endif
#if defined(SP2609Z5156CC092_MIPI_RAW)
	{SENSOR_DRVNAME_SP2609Z5156CC092_MIPI_RAW,
		{
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 0},
			{DOVDD, Vol_1800, 1},
...
/* GC */
...
#endif
#if defined(GC5025Z5157V_MIPI_RAW)
	{SENSOR_DRVNAME_GC5025Z5157V_MIPI_RAW,
		{
			{PDN,        Vol_Low,  0},
			{RST,        Vol_Low,  0},
			{AVDD,       Vol_Low, 2},
...
#endif
#if defined(GC8034Z5157V_MIPI_RAW)
	{
		SENSOR_DRVNAME_GC8034Z5157V_MIPI_RAW,
		{
			{PDN, Vol_Low, 0},
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1200, 5},
	...
	{
		SENSOR_DRVNAME_HI846Z5157V_MIPI_RAW,
		{
			{PDN, Vol_Low, 0},
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1200, 5},
...
#if defined(SP5508Z5157V_MIPI_RAW)
	{SENSOR_DRVNAME_SP5508Z5157V_MIPI_RAW,
		{
			{PDN,        Vol_Low,  0},
			{RST,        Vol_Low,  0},
			{AVDD,       Vol_Low, 2},
