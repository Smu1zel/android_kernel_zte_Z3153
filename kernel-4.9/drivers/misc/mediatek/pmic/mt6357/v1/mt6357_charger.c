...
u32 g_input_current; /* uA */
u32 g_topoff_current; /* uA */
u32 g_recharger_voltage; /* uV */
#endif
...
#ifdef CONFIG_VENDOR_POWER_VOTER
static int mt6357_get_input_current(struct charger_device *chg_dev, u32 *aicr)
{
	*aicr = g_input_current;
	return 0;
}
static int mt6357_set_input_current(struct charger_device *chg_dev, u32 limit)
{
	g_input_current = limit;
	pr_info("g_input_current=%d\n", g_input_current);
	return 0;
}

static int mt6357_get_eoc_current(struct charger_device *chg_dev, u32 *iterm)
{
	*iterm = g_topoff_current;
	return 0;
}

static int mt6357_set_eoc_current(struct charger_device *chg_dev, u32 iterm)
{
	g_topoff_current = iterm;
	pr_info("g_topoff_current=%d\n", g_topoff_current);
	return 0;
}

static int mt6357_get_rechg_voltage(struct charger_device *chg_dev, u32 *uv)
{
	*uv = g_recharger_voltage;
	return 0;
}

static int mt6357_set_rechg_voltage(struct charger_device *chg_dev, u32 uv)
{
	g_recharger_voltage = uv;
	pr_info("g_recharger_voltage=%d\n", g_recharger_voltage);
	return 0;
}
#endif
...
#ifdef CONFIG_VENDOR_POWER_VOTER
	.get_input_current = mt6357_get_input_current,
	.set_input_current = mt6357_set_input_current,
	.get_eoc_current = mt6357_get_eoc_current,
	.set_eoc_current = mt6357_set_eoc_current,
	.get_recharge_voltage = mt6357_get_rechg_voltage,
	.set_recharge_voltage = mt6357_set_rechg_voltage,
#endif
	/* Event */
