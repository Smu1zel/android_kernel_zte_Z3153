...
{
	LCM_LOGI("%s: kernel----zte_mango_st7703_hdp_5p45_skyworth_hsd_drv----\n", __func__);
	lcm_init();
}
...
struct LCM_DRIVER zte_mango_st7703_hdp_5p45_skyworth_hsd_lcm_drv = {
	.name = "zte_mango_st7703_hdp_5p45_skyworth_hsd_drv",
