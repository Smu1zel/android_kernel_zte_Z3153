...
{
	LCM_LOGI("%s: kernel----zte_mango_jd9366d_hdp_5p45_lianchuang_panda_drv----\n", __func__);
	lcm_init();
}
...
struct LCM_DRIVER zte_mango_jd9366d_hdp_5p45_lianchuang_panda_lcm_drv = {
	.name = "zte_mango_jd9366d_hdp_5p45_lcetron_panda_drv",
