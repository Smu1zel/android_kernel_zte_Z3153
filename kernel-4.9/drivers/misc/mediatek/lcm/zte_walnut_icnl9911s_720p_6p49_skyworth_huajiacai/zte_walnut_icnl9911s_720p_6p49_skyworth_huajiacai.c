...
{
	LCM_LOGI("%s: kernel ----zte_walnut_icnl9911s_720p_6p49_skyworth_huajiacai_drv----\n", __func__);
...
struct LCM_DRIVER zte_walnut_icnl9911s_720p_6p49_skyworth_huajiacai_lcm_drv = {
	.name = "zte_walnut_icnl9911s_720p_6p49_skyworth_huajiacai_drv",
