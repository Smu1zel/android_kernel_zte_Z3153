...
{
	LCM_LOGI("%s: kernel ----zte_scorpio_icnl9911c_720p_6p_skyworth_drv----\n", __func__);
...
struct LCM_DRIVER zte_scorpio_icnl9911c_720p_6p_skyworth_lcm_drv = {
	.name = "zte_scorpio_icnl9911c_720p_6p_skyworth_chipone_drv",
