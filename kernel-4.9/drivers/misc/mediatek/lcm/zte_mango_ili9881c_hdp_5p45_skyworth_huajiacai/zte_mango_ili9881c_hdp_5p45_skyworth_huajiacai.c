...
{
	LCM_LOGI("%s: kernel----zte_mango_ili9881c_hdp_5p45_skyworth_huajiacai_drv----\n", __func__);
	lcm_init();
}
...
struct LCM_DRIVER zte_mango_ili9881c_hdp_5p45_skyworth_huajiacai_lcm_drv = {
	.name = "zte_mango_ili9881c_hdp_5p45_skyworth_huajiacai_drv",
