...
static int hl7019x_set_watch_dog_timer(struct charger_device *chg_dev, u32 timer)
{
	u8 reg_value = 0;

	pr_info("hl7019x: [REG] set watchdog timer %ds\n", timer);

	reg_value = (timer - HL7019X_REG05_WDT_BASE) / HL7019X_REG05_WDT_LSB;
	hl7019x_set_value(HL7019X_REG_05, HL7019X_REG05_WDT_MASK,
			  HL7019X_REG05_WDT_SHIFT, reg_value);

	return 0;
}

static int hl7019x_plug_in(struct charger_device *chg_dev)
{
	hl7019x_set_watch_dog_timer(chg_dev, 40);

	return 0;
}

static int hl7019x_plug_out(struct charger_device *chg_dev)
{
	hl7019x_set_watch_dog_timer(chg_dev, 0);
...
static struct charger_ops hl7019x_chg_ops = {
	...
	.plug_in = hl7019x_plug_in,
	.plug_out = hl7019x_plug_out,
