...
struct charger_custom_data {
	...
	bool ta_9v_support;
	bool ta_7v_support;
	bool ta_pe20_step_adjust_support;
	...
	u32 chg1_ta_ac_charger_current_1;
	u32 chg2_ta_ac_charger_current;
	u32 chg2_ta_ac_charger_current_1;
	int slave_mivr_diff;
...
extern void zte_charger_notify_whether_is_fast_charger(struct charger_manager *info);
#endif
extern int zte_charger_notify_usb_current_max(void);
extern int zte_charger_notify_usb_voltage_max(void);

#ifdef ZTE_RESOLVE_ADAPTOR_QC_SWITCH_MTK
extern bool zte_mtk_pe_whether_is_7v_to_9v_step;
#endif
extern bool charger_ic_notify_eoc;
extern bool sw_jeita_whether_is_normal_step2;
