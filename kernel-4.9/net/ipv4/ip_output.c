...
/*ignore checking tcp pkts correct, value of uid sometimes too large*/
				pr_log_info("[IPv4] TCP SEND len=%d, uid=%d, Gpid:%d (%s), (%pI4:%hu -> %pI4:%hu), F:%d%d%d%d%d%d%d%d\n",
					ntohs(iph->tot_len),
					uid.val,
...
/*ignore checking udp pkts correct*/
				pr_log_info("[IPv4] UDP SEND len=%d, uid=%d, Gpid:%d (%s), (%pI4:%hu -> %pI4:%hu)\n",
					ntohs(iph->tot_len),
					uid.val,
					current->group_leader->pid, current->group_leader->comm,
...
/*ignore checking icmp pkts correct*/
				pr_log_info("[IPv4] ICMP SEND len=%d, uid=%d, Gpid:%d (%s), (%pI4 -> %pI4) , T: %d,C: %d\n",
					ntohs(iph->tot_len),
					uid.val,
					current->group_leader->pid, current->group_leader->comm,
					&iph->saddr,
				...
				pr_log_info("[IPv4] SEND len=%d, uid=%d, Gpid:%d (%s), (%pI4 -> %pI4), TP = %d\n",
					ntohs(iph->tot_len),
					uid.val,
					current->group_leader->pid, current->group_leader->comm,
					&iph->saddr,
