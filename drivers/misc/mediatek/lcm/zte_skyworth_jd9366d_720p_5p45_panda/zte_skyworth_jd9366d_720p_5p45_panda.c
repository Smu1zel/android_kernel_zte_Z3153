...
#define LCM_ID_SKYWORTH_JD9363D_PANDA (0xb6)
...
static void lcm_suspend(void)
{
	...
	LCM_LOGI("%s: zte_skyworth jd9366d is_shutdown_suspend=%d\n", __func__, is_shutdown_suspend);
...
{
	LCM_LOGI("%s: kernel----zte_skyworth_jd9366d_hdp_5p45_lianchuang_panda_drv----\n", __func__);
	lcm_init();
}
...
struct LCM_DRIVER zte_skyworth_jd9366d_720p_5p45_panda_lcm_drv = {
	.name = "zte_skyworth_jd9366d_720p_5p45_panda_drv",
