...
#define LCM_ID_LCETRON_ILI9881P_PANDA (0x6E)
...
{0x8f, 0x01, {0x44} },
{0x90, 0x01, {0x44} },
{0xFF, 0x03, {0x98, 0x81, 02} },
{0x57, 0x14, {0x00, 0x1B, 0x2A, 0x14, 0x18, 0x2A, 0x1E, 0x1F, 0x8D, 0xD, 0x2A, 0x77, 0x1A, 0x17, 0x4A, 0x1F, 0x26, 0x49, 0x59, 0x2C} },
{0x6B, 0x14, {0x00, 0x1B, 0x2A, 0x14, 0x18, 0x2A, 0x1E, 0x1F, 0x8D, 0x1D, 0x2A, 0x77, 0x1A, 0x17, 0x4A, 0x1F, 0x26, 0x49, 0x59, 0x2C} },
{0xFF, 0x01, {0x98, 0x81, 0x03} },
{0x80, 0x01, {0x44} },
{0x81, 0x01, {0x44} },
{0x82, 0x01, {0x44} },
{0x83, 0x01, {0x40} }, /*10bit 2:12bit 3:11bit 4:10bit 5:9bit 6:8bit*/
...
static void lcm_suspend(void)
{
	...
	LCM_LOGI("%s: zte_lcetron_ili9881p_720p_5p45_panda is_shutdown_suspend=%d\n", __func__, is_shutdown_suspend);
...
{
	LCM_LOGI("%s: kernel----zte_lcetron_ili9881p_720p_5p45_panda_drv----\n", __func__);
	lcm_init();
}
...
struct LCM_DRIVER zte_mango_lcetron_ili9881p_720p_5p45_panda_lcm_drv = {
	.name = "zte_mango_lcetron_ili9881p_720p_5p45_panda_drv",
