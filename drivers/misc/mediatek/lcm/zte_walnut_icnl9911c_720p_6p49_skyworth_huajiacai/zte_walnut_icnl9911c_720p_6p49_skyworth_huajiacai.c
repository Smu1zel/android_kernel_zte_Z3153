...
#define LCD_RST_GPIO_PIN          377 /*(GPIO159)*//*45+332*/

#define SET_RESET_PIN(v)    (set_lcm_reset_pin((v)))
...
static void set_lcm_reset_pin(unsigned int output)
{
	gpio_direction_output(LCD_RST_GPIO_PIN, output);
	gpio_set_value(LCD_RST_GPIO_PIN, output);
}
...
static struct LCM_setting_table init_setting[] = {
	...
	{0xB1, 29, {0x11, 0x44, 0x86, 0x00, 0x01, 0x00, 0x01, 0x7C, 0x01, 0x01,
				0x04, 0x08, 0x54, 0x00, 0x00, 0x00, 0x44, 0x40, 0x02, 0x01,
				0x40, 0x02, 0x01, 0x40, 0x02, 0x01, 0x40, 0x02, 0x01} },
	...
	{0xB8, 24, {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				...
				0x00, 0x00, 0x00, 0x00} },
	{0xBA, 2, {0x36, 0x36} },
	{0xBB, 13, {0x01, 0x05, 0x09, 0x11, 0x0D, 0x19, 0x1D, 0x15, 0x25, 0x69,
				0x00, 0x21, 0x25} },
	{0xBC, 14, {0x00, 0x00, 0x00, 0x00, 0x02, 0x20, 0xFF, 0x00, 0x03, 0x33,
				0x01, 0x73, 0x44, 0x00} },
	{0xBD, 10, {0x53, 0x12, 0x4F, 0xCF, 0x72, 0xA7, 0x08, 0x44, 0xAE, 0x15} },
	{0xBE, 10, {0x65, 0x65, 0x50, 0x46, 0x0C, 0x66, 0x43, 0x02, 0x0E, 0x0E} },
	{0xBF, 8, {0x07, 0x25, 0x07, 0x25, 0x7F, 0x00, 0x11, 0x04} },
	{0xC0, 9, {0x10, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0x00} },
	{0xC1, 19, {0xC0, 0x0C, 0x20, 0x7C, 0x04, 0x0C, 0x10, 0x04, 0x2A, 0x18,
				0x36, 0x00, 0x07, 0xCF, 0xFF, 0xFF, 0xC0, 0x00, 0xC0} },
	{0xC2, 1, {0x00} },
	{0xC3, 9, {0x06, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0x00, 0x81, 0x01} },
	{0xC5, 11, {0x03, 0x1C, 0xC0, 0xB8, 0x50, 0x10, 0x64, 0x44, 0x08, 0x09, 0x26} },
	{0xC6, 10, {0x87, 0x9A, 0x2A, 0x29, 0x29, 0x31, 0x7F, 0x04, 0x08, 0x00} },
	{0xC7, 22, {0xF7, 0xB1, 0x87, 0x69, 0x3B, 0x1B, 0xEA, 0x41, 0x11, 0xED,
				0xC9, 0x9E, 0xF8, 0xCF, 0xAF, 0x8A, 0x70, 0x4F, 0x1A, 0x7E,
				0xC0, 0x00} },
	{0xC8, 22, {0xF7, 0xB1, 0x87, 0x69, 0x3B, 0x1B, 0xEA, 0x41, 0x11, 0xED,
				0xC9, 0x9E, 0xF8, 0xCF, 0xAF, 0x8A, 0x70, 0x4F, 0x1A, 0x7E,
				0xC0, 0x00} },
	{0xCB, 1, {0x00} },
...
#if defined(CONFIG_TOUCHSCREEN_VENDOR)
...
{
	LCM_LOGI("%s: kernel ----zte_walnut_icnl9911c_720p_6p49_skyworth_huajiacai_drv----\n", __func__);
...
struct LCM_DRIVER zte_walnut_icnl9911c_720p_6p49_skyworth_huajiacai_lcm_drv = {
	.name = "zte_walnut_icnl9911c_720p_6p49_skyworth_huajiacai_drv",
