...
static struct LCM_setting_table init_setting[] = {
	...
	{0xB2, 17, {0x54, 0xC4, 0x82, 0x05, 0x40, 0x02, 0x01, 0x40, 0x02, 0x01,
	...
	{0xC7, 22, {0xF7, 0xB0, 0x88, 0x6A, 0x3E, 0x1E, 0xEF, 0x46, 0x16, 0xF1,
				0xCA, 0x9F, 0xF8, 0xCE, 0xB0, 0x89, 0x6E, 0x46, 0x1A, 0x7E,
				0xC0, 0x00}  },
	{0xC8, 22, {0xF7, 0xB0, 0x88, 0x6A, 0x3E, 0x1E, 0xEF, 0x46, 0x16, 0xF1,
				0xCA, 0x9F, 0xF8, 0xCE, 0xB0, 0x89, 0x6E, 0x46, 0x1A, 0x7E,
				0xC0, 0x00}  },
	{0xCB, 1, {0x00} },
...
#else
	params->dsi.PLL_CLOCK = 333;	/* this value must be in MTK suggested table */
#endif
	params->dsi.PLL_CK_CMD = 240;
	params->dsi.PLL_CK_VDO = 333;
#else
...
{
	LCM_LOGI("%s: kernel ----zte_scorpio_icnl9911s_720p_6p_skyworth_drv----\n", __func__);
...
struct LCM_DRIVER zte_scorpio_icnl9911s_720p_6p_skyworth_lcm_drv = {
	.name = "zte_scorpio_icnl9911s_720p_6p_skyworth_chipone_drv",
