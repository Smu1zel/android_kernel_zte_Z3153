...
{
	LCM_LOGI("%s: kernel ----zte_walnut_ft8006p_720p_6p49_dsi_vdo_skyworth_huajiacai_drv----\n", __func__);
...
struct LCM_DRIVER zte_walnut_ft8006p_720p_6p49_dsi_vdo_skyworth_huajiacai_lcm_drv = {
	.name = "zte_walnut_ft8006p_720p_6p49_dsi_vdo_skyworth_huajiacai_drv",
