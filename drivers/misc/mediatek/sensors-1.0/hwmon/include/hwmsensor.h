...
#define SENSOR_TYPE_SAR_2                              73
/* end sensor type */
#define SENSOR_TYPE_MAX_NUM                            SENSOR_TYPE_SAR_2
...
#define ID_SAR_2                (ID_BASE + SENSOR_TYPE_SAR_2 - 1)

/* end sensor ID */
#define ID_SENSOR_MAX_HANDLE    (ID_SAR_2)
