...
void hi846z6250cc134_otp_setting(void)
{
	LOG_INF("%s enter\n", __func__);
...
void hi846z6250cc134_otp_disable(void)
{
...
int hi846z6250cc134_otp_read_(u32 offset, u8 *data, u32 size)
{
	int i = 0;
...
int hi846z6250cc134_otp_read(u32 offset)
{
