 ...
 * Filename:
 * ---------
 *	 hi846z6250cc134_mipi_raw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "hi846z6250cc134_mipi_raw_Sensor.h"
#include "hi846z6250cc134_otp_interface.h"


#define PFX "HI846Z6250CC134_camera_sensor"
...
unsigned int hi846z6250cc134_moduleID = 0;
...
unsigned int hi846z6250cc134_otp_read_baseinfo(void)
{
	kal_uint16  base = 0;
	kal_uint16  flag = hi846z6250cc134_otp_read(HI846_OTP_BASE);
	...
	hi846z6250cc134_moduleID = hi846z6250cc134_otp_read(base);
	LOG_INF("[test] %s moduleID = 0x%x \n", __func__, hi846z6250cc134_moduleID);
	return hi846z6250cc134_moduleID;
}
static void hi846z6250cc134_otp_read_wbinfo(void)
{
	kal_uint16  base = 0;
	kal_uint16  flag = hi846z6250cc134_otp_read(HI846_OTP_WB);
	...
	g_current_otp_.rg_ratio = hi846z6250cc134_otp_read(base) << 8 | hi846z6250cc134_otp_read(base + 1);
	g_current_otp_.bg_ratio = hi846z6250cc134_otp_read(base + 2) << 8 | hi846z6250cc134_otp_read(base + 3);
	LOG_INF("HI843B_OTP_AWB rg 0x%x bg 0x%x\n", g_current_otp_.rg_ratio, g_current_otp_.bg_ratio);
}
static void hi846z6250cc134_write_gain(void)
{
...
static void hi846z6250cc134_otp_read_lscinfo(void)
{
	kal_uint16  flag = hi846z6250cc134_otp_read(HI846_OTP_LSC);
	kal_uint16  base = 0;
	kal_uint16  val = 0;
	...
	val = hi846z6250cc134_otp_read(0x021C);
	if (!val)
...
static void hi846z6250cc134_otp_update(void)
{
	LOG_INF("E\n");

	if (!otp_up_flag) {
		hi846z6250cc134_otp_setting();
		hi846z6250cc134_otp_read_baseinfo();
		hi846z6250cc134_otp_read_wbinfo();
		hi846z6250cc134_otp_read_lscinfo();
		hi846z6250cc134_otp_disable();
		otp_up_flag = true;
	}
	hi846z6250cc134_write_gain();
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	LOG_INF("get imgsensor id Read sensor id fail,i2c write id:0x%x,id: 0x%x\n",
	imgsensor.i2c_write_id, *sensor_id);
				retry--;
			} while (retry > 0);
			i++;
...
UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	LOG_INF("[test] hi846 %s feature_id = %d, *feature_para_len = %d\n", __func__, feature_id, *feature_para_len);
	switch (feature_id) {
...
UINT32 HI846Z6250CC134_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
