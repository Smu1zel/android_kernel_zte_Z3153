 ...
 * Filename:
 * ---------
 *     gc02m1bz6250cc098mipi_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "gc02m1bz6250cc098mipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc02m1b_camera_sensor"
#define LOG_1 LOG_INF("GC02M1, MIPI 2LANE\n")
/****************************   Modify end    *******************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.min_gain_iso = 100,
	.gain_step = 1,
	.gain_type = 4,/*sony:0,OV:1,Samsung:2,Hynix:3,GC:4*/
...
static void set_shutter_frame_length(kal_uint16 shutter, kal_uint16 frame_length)
{
	...
	LOG_INF("Enter set shutter frame length! shutter =%d\n", shutter);
	...
	UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	LOG_INF("[test] gc02m1b %s feature_id = %d, *feature_para_len = %d\n", __func__, feature_id, *feature_para_len);
	switch (feature_id) {
/*
...
UINT32 GC02M1BZ6250CC098_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
