...
#include "hi846z5156cc132mipiraw_Sensor.h"
#include "hi846z5156cc132_otp_interface.h"

#define PFX "hi846z5156cc132_camera_sensor"
...
#define per_frame 1
#define HI846Z5156CC132_DEBUG_OTP 0

#define HI846Z5156CC132_OTP_BASE 0x0201
#define HI846Z5156CC132_OTP_BASE_LEN 17

#define HI846Z5156CC132_OTP_WB 0x0c5f
#define HI846Z5156CC132_OTP_WB_LEN 30

#define HI846Z5156CC132_OTP_LSC 0x0235
#define HI846Z5156CC132_OTP_LSC_LEN 867

#define HI846Z5156CC132_RG_Ratio_Typical   0x110
#define HI846Z5156CC132_BG_Ratio_Typical   0x11a

//extern struct mutex HI846Z5156CC132_OTP_MUTEX;
DEFINE_MUTEX(HI846Z5156CC132_OTP_MUTEX);
...
static kal_uint16 hi846z5156cc132_table_write_cmos_sensor(
...
static void hi846z5156cc132_otp_read_baseinfo(void)
{
	kal_uint16  base = 0;
#if HI846Z5156CC132_DEBUG_OTP
	kal_uint16  val = 0;
	kal_uint16  i = 0;
	kal_uint16  checksum = 0;
#endif
	kal_uint16  flag = hi846z5156cc132_otp_read(HI846Z5156CC132_OTP_BASE);

	LOG_INF("HI846Z5156CC132_OTP baseinfo flag 0x%x\n", flag);
	...
	if (flag == 0x01) {
		...
		LOG_INF(" HI846Z5156CC132_OTP base info fail flag %x\n", flag);
	}
#if HI846Z5156CC132_DEBUG_OTP
	for (i = 0; i < HI846Z5156CC132_OTP_BASE_LEN; i++) {
		val = hi846z5156cc132_otp_read(base + i);
		LOG_INF("HI846Z5156CC132_OTP i %d addr 0x%x  val 0x%x\n", i, base+i, val);
		checksum = checksum + val;
		mDELAY(5);
	}
#endif
}
static void hi846z5156cc132_otp_read_wbinfo(void)
{
	kal_uint16  base = 0;
#if HI846Z5156CC132_DEBUG_OTP
	kal_uint16  val = 0;
...
#endif
	kal_uint16  flag = hi846z5156cc132_otp_read(HI846Z5156CC132_OTP_WB);
...
#if HI846Z5156CC132_DEBUG_OTP
	for (i = 0; i < HI846Z5156CC132_OTP_WB_LEN; i++) {
		val = hi846z5156cc132_otp_read(base + i);
		mDELAY(5);
...
#endif
	g_current_otp_.rg_ratio = hi846z5156cc132_otp_read(base) << 8 | hi846z5156cc132_otp_read(base + 1);
	g_current_otp_.bg_ratio = hi846z5156cc132_otp_read(base + 2) << 8 | hi846z5156cc132_otp_read(base + 3);
	LOG_INF("HI843B_OTP_AWB rg 0x%x bg 0x%x\n", g_current_otp_.rg_ratio, g_current_otp_.bg_ratio);
}
static void hi846z5156cc132_write_gain(void)
{
	kal_uint16   R_gain, G_gain, B_gain;

	LOG_INF("HI843B_OTP_AWB rg 0x%x bg 0x%x\n", g_current_otp_.rg_ratio, g_current_otp_.bg_ratio);
	if (g_current_otp_.rg_ratio == 0x0 || g_current_otp_.bg_ratio == 0x0) {
		LOG_INF("HI846Z5156CC132_OTP_AWB read fail current rg bg is 0\n");
	}
	R_gain = 0x200;
	B_gain = 0x200;
	G_gain = 0x200;

	R_gain = (0x200 * HI846Z5156CC132_RG_Ratio_Typical) / g_current_otp_.rg_ratio;
	B_gain = (0x200 * HI846Z5156CC132_BG_Ratio_Typical) / g_current_otp_.bg_ratio;
	...
	LOG_INF("HI846Z5156CC132_OTP_AWB %s,after calcuate: R_gain = 0x%x, G_gain = 0x%x, B_gain = 0x%x\n",
		__func__, R_gain, G_gain, B_gain);
	LOG_INF("HI846Z5156CC132_OTP_AWB %s exit\n", __func__);
	if (G_gain >= 0x200) {
...
static void hi846z5156cc132_otp_read_lscinfo(void)
{
	kal_uint16  flag = hi846z5156cc132_otp_read(HI846Z5156CC132_OTP_LSC);
	kal_uint16  base = 0;
	kal_uint16  val = 0;
#if HI846Z5156CC132_DEBUG_OTP
	kal_uint16  i = 0;
	kal_uint16  checksumwb = 0;
#endif
	LOG_INF("HI846Z5156CC132_OTP_LSC lscinfo flag 0x%x\n", flag);
	...
	if (flag == 0x01) {
		...
		LOG_INF(" HI846Z5156CC132_OTP_LSC lscinfo fail flag 0x%x\n", flag);
	}
	val = hi846z5156cc132_otp_read(0x021C);
	if (!val)
		LOG_INF(" HI846Z5156CC132_OTP_LSC lsc update success 0x%x\n", val);
	else
		LOG_INF(" HI846Z5156CC132_OTP_LSC lsc update fail 0x%x\n", val);
#if HI846Z5156CC132_DEBUG_OTP
	for (i = 0; i < HI846Z5156CC132_OTP_LSC_LEN; i++) {
		val = hi846z5156cc132_otp_read(base + i);
		mDELAY(5);
		LOG_INF("HI846Z5156CC132_OTP_LSC lsc addr 0x%x 0x%x\n", base + i, val);
		checksumwb = checksumwb + val;
	}
#endif

}
static void hi846z5156cc132_otp_update(void)
{
	mutex_lock(&HI846Z5156CC132_OTP_MUTEX);
	LOG_INF("E\n");
	if (!otp_up_flag) {
		hi846z5156cc132_otp_setting();
		hi846z5156cc132_otp_read_baseinfo();
		hi846z5156cc132_otp_read_wbinfo();
		hi846z5156cc132_otp_read_lscinfo();
		hi846z5156cc132_otp_disable();
		otp_up_flag = true;
	}
	hi846z5156cc132_write_gain();
	mutex_unlock(&HI846Z5156CC132_OTP_MUTEX);
}
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_hi846z5156cc132[] = {
	0x2000, 0x987A,
	0x2002, 0x00FF,
	0x2004, 0x0047,
	0x2006, 0x3FFF,
...
{
#if MULTI_WRITE
	hi846z5156cc132_table_write_cmos_sensor(
		addr_data_pair_init_hi846z5156cc132,
		sizeof(addr_data_pair_init_hi846z5156cc132) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_hi846z5156cc132[] = {
	0x002E, 0x3311,
	0x0032, 0x3311,
	0x0026, 0x0040,
	0x002C, 0x09CF,
...
#if MULTI_WRITE
	hi846z5156cc132_table_write_cmos_sensor(
		addr_data_pair_preview_hi846z5156cc132,
		sizeof(addr_data_pair_preview_hi846z5156cc132) /
		sizeof(kal_uint16));
#else
	LOG_INF("E preview\n");
	/*Sensor Information////////////////////////////
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_fps_hi846z5156cc132[] = {
	0x002E, 0x1111,
	0x0032, 0x1111,
	0x0026, 0x0040,
	0x002C, 0x09CF,
...
kal_uint16 addr_data_pair_capture_30fps_hi846z5156cc132[] = {
	0x002E, 0x1111,
	0x0032, 0x1111,
	0x0026, 0x0040,
	0x002C, 0x09CF,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
	hi846z5156cc132_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_hi846z5156cc132,
		sizeof(addr_data_pair_capture_30fps_hi846z5156cc132) /
		sizeof(kal_uint16));
	} else {
	hi846z5156cc132_table_write_cmos_sensor(
		addr_data_pair_capture_fps_hi846z5156cc132,
		sizeof(addr_data_pair_capture_fps_hi846z5156cc132) /
		sizeof(kal_uint16));
	}
#else
	if (currefps == 300) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_hi846z5156cc132[] = {
	0x002E, 0x1111,
	0x0032, 0x1111,
	0x0026, 0x0040,
	0x002C, 0x09CF,
...
#if MULTI_WRITE
	hi846z5156cc132_table_write_cmos_sensor(
		addr_data_pair_video_hi846z5156cc132,
		sizeof(addr_data_pair_video_hi846z5156cc132) /
		sizeof(kal_uint16));
#else
	  /*Sensor Information////////////////////////////
	  //Sensor		: Hi-846
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_hi846z5156cc132[] = {
	0x002E, 0x7711,
	0x0032, 0x7711,
	0x0026, 0x0148,
	0x002C, 0x08C7,
...
#if MULTI_WRITE
	hi846z5156cc132_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi846z5156cc132,
		sizeof(addr_data_pair_hs_video_hi846z5156cc132) /
		sizeof(kal_uint16));
#else
	//Sensor Information////////////////////////////
	//Sensor	  : Hi-846
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_hi846z5156cc132[] = {
	0x002E, 0x3311,
	0x0032, 0x3311,
	0x0026, 0x0238,
	0x002C, 0x07D7,
...
#if MULTI_WRITE
	hi846z5156cc132_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi846z5156cc132,
		sizeof(addr_data_pair_slim_video_hi846z5156cc132) /
		sizeof(kal_uint16));
#else
	/*Sensor Information////////////////////////////
	//Sensor	  : Hi-846
...
UINT32 HI846Z5156CC132_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc =  &sensor_func;
	return ERROR_NONE;
}	/*	HI846Z5156CC132_MIPI_RAW_SensorInit	*/
