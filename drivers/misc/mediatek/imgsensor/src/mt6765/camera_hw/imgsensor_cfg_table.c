...
#if  defined(HI846Z6250CC137_MIPI_RAW) || defined(GC8034Z6250CC137_MIPI_RAW)
	{
...
#if defined(GC02M1BZ6250CC098_MIPI_RAW)
	{
...
#elif defined(ZTE_SP2509_094_A7S)
	{
		IMGSENSOR_SENSOR_IDX_MAIN2,
		IMGSENSOR_I2C_DEV_2,
		{
...
#elif defined(ZTE_HI846_134_A7S)
	{
		IMGSENSOR_SENSOR_IDX_SUB2,
		IMGSENSOR_I2C_DEV_0,
		{
...
#if defined(HI1634Z6250CC142_MIPI_RAW)
	{SENSOR_DRVNAME_HI1634Z6250CC142_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 0},
			{AVDD, Vol_2800, 0},
...
#endif
#if defined(GC8034Z6250CC137_MIPI_RAW)
	{SENSOR_DRVNAME_GC8034Z6250CC137_MIPI_RAW,
		{
			{RST, Vol_Low, 0},
			{DOVDD, Vol_1800, 50},
			{DVDD, Vol_1200, 60},
...
#endif
#if defined(HI846Z6250CC137_MIPI_RAW)
	{
		SENSOR_DRVNAME_HI846Z6250CC137_MIPI_RAW,
		{
			{DOVDD, Vol_1800, 0},
			{AVDD, Vol_2800, 0},
			{DVDD, Vol_1200, 0},
...
#if defined(GC02M1BZ6250CC098_MIPI_RAW)
	{
		SENSOR_DRVNAME_GC02M1BZ6250CC098_MIPI_RAW,
		{
			{RST,        Vol_Low,  0},
			{DOVDD,      Vol_1800, 1},
			{AVDD,       Vol_2800, 1},
...
#if defined(HI846Z6250CC134_MIPI_RAW)
	{
		SENSOR_DRVNAME_HI846Z6250CC134_MIPI_RAW,
		{
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 0},
			{DOVDD, Vol_1800, 0},
