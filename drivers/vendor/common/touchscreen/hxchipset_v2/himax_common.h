...
#define HX_KEY_SINGLE_CLICK 276
#define HX_KEY_FP_DOWN      277
#define HX_KEY_FP_UP        278
#define HX_KEY_ONE_KEY      279 /* unused, just for config */
