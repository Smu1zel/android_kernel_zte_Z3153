...
extern void mtk_pe20_set_is_cable_out_occur(struct charger_manager *pinfo,
					bool out);
extern void mtk_pe20_set_is_plug_in(struct charger_manager *pinfo);
extern void mtk_pe20_set_is_plug_out(struct charger_manager *pinfo);
...
static inline void mtk_pe20_set_is_plug_in(struct charger_manager *pinfo)
{
}

static inline void mtk_pe20_set_is_plug_out(struct charger_manager *pinfo)
{
}
