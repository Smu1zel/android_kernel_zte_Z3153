...
# Add DCT directories to sys.path to support relative imports in Python 3
dct_dir = os.path.dirname(os.path.abspath(__file__))
sys.path.append(dct_dir)
sys.path.append(os.path.join(dct_dir, 'obj'))
sys.path.append('.')
sys.path.append('..')
